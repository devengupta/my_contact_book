class ContactsController < ApplicationController
  ...
  def index
    ...
    elsif request.GET['favorites']
      @contacts = Contact.my_contacts current_user, :favorites => true
    elsif request.GET['q']
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:name, :email, :phone, :cell, :des, :birthdate, :group_id, :user_id, :street, :city, :zipcode, :img_url, :country,:favorites)
    end
end
